...
public class TestManyToMany {
	public static void main( String[] args )
	{
		...
		primary1.setEmp_id(57);
		primary1.setManager_id(103);
		primary1.setMobile_number(784561235);
		primary1.setName("varuni");
		primary1.setOfficial_mail_id("varuni123@gmail.com");
		...
		proj.setProj_id(15);
		proj.setProj_name("LIFI technology");
		...
		proj1.setProj_id(16);
		proj1.setProj_name("WIFI technology");
