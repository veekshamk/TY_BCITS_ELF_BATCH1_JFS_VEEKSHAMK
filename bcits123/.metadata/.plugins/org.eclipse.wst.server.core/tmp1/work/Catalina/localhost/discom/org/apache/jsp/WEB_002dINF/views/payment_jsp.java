 ...
 * Generated at: 2020-02-10 12:45:45 UTC
...
public final class payment_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String errMsg=(String)request.getAttribute("errMsg");
	String msg=(String)request.getAttribute("msg");
      ...
      out.write("<title>Consumer Payment Page</title>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<form action=\"./successPayment\" method=\"post\">\r\n");
      out.write("\t\t<div class=\"padding\">\r\n");
      out.write("\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t<div class=\"col-sm-6\">\r\n");
      out.write("\t\t\t\t\t<div class=\"card\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"card-header\">\r\n");
      out.write("\t\t\t\t\t\t\t<strong>Credit Card</strong> <small>enter your card\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tid=\"name\" type=\"text\" placeholder=\"Enter your name\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"name\">Amount</label> <input class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tid=\"amount\" name=\"amount\" type=\"number\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"0000 0000 0000 0000\" autocomplete=\"email\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-group-append\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-text\"> <i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"mdi mdi-credit-card\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"ccmonth\">Month</label> <select class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"ccmonth\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group col-sm-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"ccyear\">Year</label> <select class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"ccyear\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"cvv\">CVV/CVC</label> <input class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tid=\"cvv\" type=\"text\" placeholder=\"123\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"card-footer\">\r\n");
      out.write("\t\t\t\t\t\t\t<button class=\"btn btn-sm btn-success float-right\" type=\"submit\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\"mdi mdi-gamepad-circle\"></i> Continue\r\n");
      out.write("\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t<button class=\"btn btn-sm btn-danger\" type=\"reset\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\"mdi mdi-lock-reset\"></i> Reset\r\n");
      out.write("\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<script src=\"payment.js\"></script>\r\n");
      out.write("\t</form>\r\n");
 ...
 if(errMsg!=null && !errMsg.isEmpty()){ 
  ...
  private boolean _jspx_meth_spring_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/payment.jsp(11,0) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005furl_005f0.setVar("css");
      // /WEB-INF/views/payment.jsp(11,0) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005furl_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/payment.jsp(12,0) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005furl_005f1.setVar("js");
      // /WEB-INF/views/payment.jsp(12,0) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005furl_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/payment.jsp(13,0) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_spring_005furl_005f2.setVar("images");
      // /WEB-INF/views/payment.jsp(13,0) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
